...
<p align="center">
    ...
    <br/>
    <br/>
    <b>Divine Justice · This is a <a href="https://www.zilch.dev">Zilch</a> bot · Game <a href="https://www.zilch.dev/table-tennis">Table Tennis</a></b>
    <br/>
    <br/>
    <a href="https://codespaces.new/erikhparkinson/divine-justice?quickstart=1"><img src="https://github.com/codespaces/badge.svg"/></a>
</p>
<br/>
<br/>
...
_Open **Divine Justice** in a code editor._

⭐ **[Go to codespaces.new/erikhparkinson/divine-justice ›](https://codespaces.new/erikhparkinson/divine-justice?quickstart=1)**
...
_Connect **Divine Justice** to Zilch with the `./connect` (or on Windows `.\connect.cmd`) command._

[Open a terminal](https://code.visualstudio.com/docs/terminal/basics), `cd` to the bot directory if needed, run `./connect` and follow the in-terminal instructions. This will establish a connection between Zilch and Divine Justice. If you encounter any issues see the [detailed setup instructions](#detailed-setup-instructions) below.

<br/>

## Step 3 › Have Fun

_Play a game with **Divine Justice**._
